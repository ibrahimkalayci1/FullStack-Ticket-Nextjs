...
const Header = () => {
  return (
    <>
    <header className=' bg-zinc-900 border-b border-zinc-800 px-6 py-4 h-21 '>
      <div className=' flex items-center justify-between gap-4' >
        {/* search */}
        <div className=' flex-1 max-w-md' >
          <div className=' relative'>
            <Search className=' absolute left-3 top-1/2 
            transform -translate-y-1/2 text-gray-400 size-4'/>
            <input type="text"
              placeholder='Ticket ara...'
              className=' w-full pl-10 pr-4 py-2 border-zinc-700 
              rounded-lg 
            bg-zinc-800 text-gray-100 placeholder-gray-500 
            focus:outline-none
            focus:ring-2 focus:ring-blue-500 focus:border-t-transparent'
            />
          </div>
        ...
        <div className=' flex items-center gap-2 md:gap-4'>
          <button className=' relative p-2 text-gray-400
           hover:text-gray-100
            hover:bg-zinc-800 rounded-lg transition'>
            <Bell className=' size-5' />
            <span className=' absolute -top-1 -right-1 size-4
             bg-red-500 
