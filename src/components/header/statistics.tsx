...
const Statistics:FC = async () => {
    // await wait(1000);
    const {totalTickets,ticketsByStatus, averagePriority} = await 
    getStatistics()
  return (
    <div className=' py-4 grid grid-cols-2 md:grid-cols-4 gap-4 px-6 
    bg-zinc-900 border-b border-zinc-800'>
      ...
      <div className=' text-xs text-blue-400/70'>Çözüldü</div>
      ...
      <div className=' text-xs text-blue-400/70'>Beklemede</div>
      ...
      <div className=' text-xs text-blue-400/70'>Ort. Öncelik</div>
